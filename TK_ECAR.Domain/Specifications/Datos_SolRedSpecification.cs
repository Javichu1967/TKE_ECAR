...
namespace TK_ECAR.Domain.Specifications
{
    ...
    [Serializable]
    public partial class Datos_SolRedSpecification : ISpecification<Datos_SolRed>
    {
    	...
    	/// Initializes a new instance of the <see cref="Datos_SolRedSpecification"/> class.
    	/// </summary>
    	public Datos_SolRedSpecification()
    	{
    	...
    	public Datos_SolRedSpecification(bool initializeNavigationProperties)
    	{
    	...
    	public Expression<Func<Datos_SolRed, bool>> GetExpression()
    	{
    		Expression<Func<Datos_SolRed, bool>> expression = x => true;
    	...
    	public bool IsSatisfiedBy(Datos_SolRed entity)
    	{
    		// convert single entity to a IQueryable object, 
    		// in order to be able to use lambda expressions
    		IQueryable<Datos_SolRed> entities = (new[] { entity }).AsQueryable();
