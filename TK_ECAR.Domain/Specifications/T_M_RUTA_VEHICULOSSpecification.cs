...
namespace TK_ECAR.Domain.Specifications
{
    ...
    [Serializable]
    public partial class T_M_RUTA_VEHICULOSSpecification : ISpecification<T_M_RUTA_VEHICULOS>
    {
    
        public Nullable<int> ID_RUTA_VEHICULO
        {
            get; 
            set;
        }
    		
    	public IEnumerable<Nullable<int>> ID_RUTA_VEHICULOIN
    	{
    		get;
    		set;
    	}
    
    	public Nullable<int> ID_RUTA_VEHICULOFrom
    	{
    		get;
    		set;
    	}
    	
    	public Nullable<int> ID_RUTA_VEHICULOTo
    	{
    		get;
    		set;
    	}
    	...
    	/// Initializes a new instance of the <see cref="T_M_RUTA_VEHICULOSSpecification"/> class.
    	/// </summary>
    	public T_M_RUTA_VEHICULOSSpecification()
    	{
    	...
    	public T_M_RUTA_VEHICULOSSpecification(bool initializeNavigationProperties)
    	{
    	...
    	public Expression<Func<T_M_RUTA_VEHICULOS, bool>> GetExpression()
    	{
    		Expression<Func<T_M_RUTA_VEHICULOS, bool>> expression = x => true;
    
    		if(ID_RUTA_VEHICULO.HasValue)
    			expression = expression.And(x => x.ID_RUTA_VEHICULO == ID_RUTA_VEHICULO.Value);
    
    		if(ID_RUTA_VEHICULOIN != null && ID_RUTA_VEHICULOIN.Count() > 0)
    			expression = expression.And(x => ID_RUTA_VEHICULOIN.Contains(x.ID_RUTA_VEHICULO));
    	
    		if(ID_RUTA_VEHICULOFrom.HasValue)
    			expression = expression.And(x => x.ID_RUTA_VEHICULO >= ID_RUTA_VEHICULOFrom.Value);
    			
    		if(ID_RUTA_VEHICULOTo.HasValue)
    			expression = expression.And(x => x.ID_RUTA_VEHICULO <= ID_RUTA_VEHICULOTo.Value);
    	...
    	public bool IsSatisfiedBy(T_M_RUTA_VEHICULOS entity)
    	{
    		// convert single entity to a IQueryable object, 
    		// in order to be able to use lambda expressions
    		IQueryable<T_M_RUTA_VEHICULOS> entities = (new[] { entity }).AsQueryable();
