...
namespace TK_ECAR.Domain.Specifications
{
    ...
    [Serializable]
    public partial class Datos_LeasePlanSpecification : ISpecification<Datos_LeasePlan>
    {
    	...
    	public IEnumerable<string> SociedadIN
    	{
    		get;
    		set;
    	}
    
    	public string SociedadContains
    	{
    		get;
    		set;
    	}
    	
    	public string SociedadStartsWith
    	{
    		get;
    		set;
    	}
    	
    	public string SociedadEndsWith
    	{
    		get;
    		set;
    	}
    	...
    	/// Initializes a new instance of the <see cref="Datos_LeasePlanSpecification"/> class.
    	/// </summary>
    	public Datos_LeasePlanSpecification()
    	{
    	...
    	public Datos_LeasePlanSpecification(bool initializeNavigationProperties)
    	{
    	...
    	public Expression<Func<Datos_LeasePlan, bool>> GetExpression()
    	{
    		Expression<Func<Datos_LeasePlan, bool>> expression = x => true;
    		...
    		if(!string.IsNullOrWhiteSpace(Sociedad))  
    			expression = expression.And(x => x.Sociedad.Equals(Sociedad));
    			
    		if(!string.IsNullOrWhiteSpace(SociedadContains))  
    			expression = expression.And(x => x.Sociedad.Contains(SociedadContains));
    			
    		if(!string.IsNullOrWhiteSpace(SociedadStartsWith))
    			expression = expression.And(x => x.Sociedad.StartsWith(SociedadStartsWith));
    
    		if(!string.IsNullOrWhiteSpace(SociedadEndsWith))
    			expression = expression.And(x => x.Sociedad.EndsWith(SociedadEndsWith));
    	...
    	public bool IsSatisfiedBy(Datos_LeasePlan entity)
    	{
    		// convert single entity to a IQueryable object, 
    		// in order to be able to use lambda expressions
    		IQueryable<Datos_LeasePlan> entities = (new[] { entity }).AsQueryable();
