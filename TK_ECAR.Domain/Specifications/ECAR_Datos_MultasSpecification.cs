...
namespace TK_ECAR.Domain.Specifications
{
    ...
    [Serializable]
    public partial class ECAR_Datos_MultasSpecification : ISpecification<ECAR_Datos_Multas>
    {
    	...
    	/// Initializes a new instance of the <see cref="ECAR_Datos_MultasSpecification"/> class.
    	/// </summary>
    	public ECAR_Datos_MultasSpecification()
    	{
    	...
    	public ECAR_Datos_MultasSpecification(bool initializeNavigationProperties)
    	{
    	...
    	public Expression<Func<ECAR_Datos_Multas, bool>> GetExpression()
    	{
    		Expression<Func<ECAR_Datos_Multas, bool>> expression = x => true;
    	...
    	public bool IsSatisfiedBy(ECAR_Datos_Multas entity)
    	{
    		// convert single entity to a IQueryable object, 
    		// in order to be able to use lambda expressions
    		IQueryable<ECAR_Datos_Multas> entities = (new[] { entity }).AsQueryable();
