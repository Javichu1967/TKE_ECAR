...
namespace TK_ECAR.Domain.Specifications
{
    ...
    [Serializable]
    public partial class ECAR_Datos_SolRedSpecification : ISpecification<ECAR_Datos_SolRed>
    {
    	...
    	/// Initializes a new instance of the <see cref="ECAR_Datos_SolRedSpecification"/> class.
    	/// </summary>
    	public ECAR_Datos_SolRedSpecification()
    	{
    	...
    	public ECAR_Datos_SolRedSpecification(bool initializeNavigationProperties)
    	{
    	...
    	public Expression<Func<ECAR_Datos_SolRed, bool>> GetExpression()
    	{
    		Expression<Func<ECAR_Datos_SolRed, bool>> expression = x => true;
    	...
    	public bool IsSatisfiedBy(ECAR_Datos_SolRed entity)
    	{
    		// convert single entity to a IQueryable object, 
    		// in order to be able to use lambda expressions
    		IQueryable<ECAR_Datos_SolRed> entities = (new[] { entity }).AsQueryable();
