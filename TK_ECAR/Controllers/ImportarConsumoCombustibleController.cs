...
{
    public class ImportarConsumoCombustibleController : BaseController
    {
        ...
        public JsonResult ImportarCombustible(ImportacionDatosModels modelo)
        {
            var result = "OK";

            Session["incidencias"] = new ResumenImportacionModels();
            if (!new GlobalProcesosSignalR().ImportarConsumosCombustibleCombustible(modelo, ((ResumenImportacionModels)Session["incidencias"]), hubContext))
            {
                result = "ERROR";
            }
        ...
        public JsonResult ArchivoYaProcesado(string archivo)
        {
            ...
            if (new ImportacionConsumoCombustibleService().Archivo_ConsumoCombustible_ImportadoConAnterioridad(archivo))
            {
                result = "SI";
            }
