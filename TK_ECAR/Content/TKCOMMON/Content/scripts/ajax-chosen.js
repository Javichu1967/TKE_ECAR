...
(function ($) {
    ...
    defaultOptions = {
        ...
        loadingImg: "../img/app/loading.gif"
    };
    return ajaxChosen = (function () {
	    ...
	    if (chosenOptions.loadingImg != null)
	        this.options.loadingImg = chosenOptions.loadingImg;
        }
        ...
        ajaxChosen.prototype.update_list = function (evt) {
            ...
            options.success = function (data) {              
                var result_success = _this.show_results(data);
                _this.search_field.get(0).style.background = '';
            ...
            return this.timer = setTimeout(function () {
                ...
                if (_this.options.loadingImg != "") {
                    _this.search_field.get(0).style.background = 'transparent url("' + _this.options.loadingImg + '") no-repeat right 3px';
                }
